...
/**
 * Entering point for the web application.<br>
 * 
 * TODO: add reference to generated XML format
 */
public class MainViewAction extends ViewAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Element text = new Element("main");

		document.getRootElement().addContent(text);

		request.setAttribute(Keys.NEXT_FORWARD_NAME, "mainView");
