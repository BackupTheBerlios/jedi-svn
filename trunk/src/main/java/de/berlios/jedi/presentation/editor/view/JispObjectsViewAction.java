 ...
 * Objects from the specified Jisp Icon.<br>
 ...
 * 
 * <p>
 * NEXT_FORWARD_NAME Key attribute is set to "jispObjectsView".
 * </p>
 * 
 * TODO: add reference to generated XML format
 */
public class JispObjectsViewAction extends ViewAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if (jispIcon != null) {
			...
			Element jispObjectsElement = new Element("jispObjects");

			document.getRootElement().addContent(jispObjectsElement);
			...
			while (jispObjects.hasNext()) {
				...
				jispObjectsElement.addContent(jispPackageToXml
						.createJispObjectElement(jispObject));
			}
		}

		request.setAttribute(Keys.NEXT_FORWARD_NAME, "jispObjectsView");
