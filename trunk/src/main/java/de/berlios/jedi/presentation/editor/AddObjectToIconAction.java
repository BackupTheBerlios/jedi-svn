...
/**
 * <p>
 * Adds a Jisp Object to a Jisp Icon.<br>
 ...
 * </p>
 */
public class AddObjectToIconAction extends ActionWithErrorSupport {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		JispObject jispObjectClone = (JispObject) jispObject.clone();
		new EditorLogicService().addJispObjectToJispIcon(jispObjectClone,
				jispIcon);
		jispIdManager.registerJispObject(jispObjectClone);
