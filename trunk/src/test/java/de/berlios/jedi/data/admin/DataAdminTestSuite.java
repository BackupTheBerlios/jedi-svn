 ...
 */
public class DataAdminTestSuite {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite("de.berlios.jedi.data.admin");
		suite.addTest(new TestSuite(AdminDataServiceTest.class));
		return suite;
	}
	...
	public static void main(String[] args) {
		junit.swingui.TestRunner.run(DataAdminTestSuite.class);
	}
}
