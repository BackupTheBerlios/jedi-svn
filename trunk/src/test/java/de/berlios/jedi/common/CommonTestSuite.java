...
package de.berlios.jedi.common;

import junit.framework.Test;
import junit.framework.TestSuite;
import de.berlios.jedi.common.jisp.CommonJispTestSuite;
...
public class CommonTestSuite {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite("de.berlios.jedi.common");
		suite.addTest(CommonJispTestSuite.suite());
		return suite;
	}
