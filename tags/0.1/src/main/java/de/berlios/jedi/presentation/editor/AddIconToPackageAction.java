...
/**
 * <p>
 * Adds a Jisp Icon to the Jisp Package being created.<br>
 ...
 * </p>
 */
public class AddIconToPackageAction extends ActionWithErrorSupport {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		JispIcon jispIconClone = (JispIcon) jispIcon.clone();
		new EditorLogicService().addJispIconToJispPackage(jispIconClone,
				jispPackage);
		jispIdManager.registerJispIcon(jispIconClone);
