...
/**
 * <p>
 * Adds a Jisp Text to a Jisp Icon.<br>
 ...
 * </p>
 */
public class AddTextToIconAction extends ActionWithErrorSupport {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String jispTextText = request.getParameter("jispTextText");
		...
		jispText.setText(jispTextText);
		new EditorLogicService().addJispTextToJispIcon(jispText, jispIcon);
		jispIdManager.registerJispText(jispText);
