 ...
 * Jisp Packages.<br>
 * Each Jisp Package contains its id and all its Jisp Icons.<br>
 ...
 * 
 * <p>
 * NEXT_FORWARD_NAME Key attribute is set to "jispPackagesListView".
 * </p>
 * 
 * TODO: add reference to generated XML format
 */
public class JispPackagesListViewAction extends ViewAction {
