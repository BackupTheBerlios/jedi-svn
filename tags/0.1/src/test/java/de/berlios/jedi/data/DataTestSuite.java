...
import de.berlios.jedi.data.admin.DataAdminTestSuite;
...
public class DataTestSuite {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite("de.berlios.jedi.data");
		suite.addTest(DataAdminTestSuite.suite());

		suite.addTest(new TestSuite(JispPackagesCacheTest.class));
		suite.addTest(new TestSuite(DataServiceTest.class));
		return suite;
	}
	...
	public static void main(String[] args) {
		junit.swingui.TestRunner.run(DataTestSuite.class);
	}
}
